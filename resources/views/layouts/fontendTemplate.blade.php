...
<body class="bg-white overflow-auto font-family-karla">
    ...
    <div class="h-screen">
        ...
        <!-- Text Header -->
        {{-- <header class="w-full h-5/6	 bg-red-500 ">
        ...
        <header id="up" class="bg-fixed bg-no-repeat bg-center bg-cover h-screen relative">
            ...
            <div class="h-4/5 bg-opacity-50  flex items-center justify-center bg-hero-pattern" >
              <div class="text-center bg-opacity-40 h-full w-full flex flex-col justify-center bg-black">
                <h1 class="font-bold text-gray-100 uppercase tracking-widest text-9xl " > LaraBlog </h1>
                 <p class="text-md text-gray-200 text-2xl ">
                     a blog build with <span class="font-bold text-gray-200 ">LARAVEL FRAMEWORK</span> 
                 </p>
              </div>
            </div>
          </header>
